		...
		<div id="aa" class="easyui-accordion"
			...
			<div title="基础数据录入">
				...
				<ul style="list-style: none;padding: 0px;margin:0px;">
					<li style="padding: 6px;"><a href="${proPath}/base/goURL/supplier/supplier.action" title="供应商管理"
						style="text-decoration: none;display: block;font-weight:bold;">供应商管理</a>
					</li>
					<li style="padding: 6px;"><a href="${proPath}/base/goURL/goods/goods.action" title="商品管理"
						style="text-decoration: none;display: block;font-weight:bold;">商品管理</a>
					</li>
					<li style="padding: 6px;"><a href="${proPath}/base/goURL/store/store.action" title="仓库管理"
			...
			<div title="采购管理">
				...
				<ul style="list-style: none;padding: 0px;margin:0px;">
					...
					<li style="padding: 6px;"><a href="${proPath}/base/goURL/goods/goods.action" title="商品退货"
